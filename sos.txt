if game.PlaceId == 2753915549 or game.PlaceId == 4442272183 or game.PlaceId == 7449423635 then
    ...
    local Nike = RenUi:AddTab("Nike","7055646372")
    --------------------------------------------------------------------
    Attack:AddSeperator("SuperFastAttack")

    Attack:AddToggle("Fast Attack"_G.FastAttack,function(value)
        _G.FastAttack = value
    end)
...
local StopCamera = require(game.ReplicatedStorage.Util.CameraShaker)StopCamera:Stop()
    ...
    Attack:AddSeperator("Auto Click")

    Attack:AddToggle("Auto Click"_G.AutoClick,function(value)
        _G.AutoClick = value
    end)
