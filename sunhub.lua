if game.PlaceId == 2753915549 or game.PlaceId == 4442272183 or game.PlaceId == 7449423635 then
    _G.Color = Color3.fromRGB(255,165,0)
                ...
                if not isnil(v.Character) then
                    if not v.Character.Head:FindFirstChild('NameEsp'..v.Name) then
                        ...
                        if v.Team == game:GetService("Players").LocalPlayer.Team then
                            ...
                            ESP.TextColor3 = Color3.new(255, 165, 0)
                        end
                        ESP.TextSize = 14
                        ...
                        HealthESP.TextColor3 = Color3.fromRGB(255, 165, 0)
    ...
    --------------------------------------------------------------------
    local RenUi = library:AddWindow("SunHub | beta",Enum.KeyCode.RightControl)
    --------------------------------------------------------------------
    ...
    local FastAttack = RenUi:AddTab("FastAttack","7055646372")
    --------------------------------------------------------------------
    ...
    Main:AddSeperator("Candy")
	local CandyFarm = Main:AddToggle("Auto Farm Candy",_G.Auto_Candy,function(value)
        _G.Auto_Candy = value
        StopTween(_G.Auto_Candy)
    end)
    
    spawn(function()
        while wait() do 
            if _G.Auto_Candy and World3 then
                pcall(function()
    ...
    spawn(function()
        while task.wait() do
		  ...
		  if _G.Auto_Candy and StartMagnetCandyMon then
                            if (v.Name == "Candy Pirate [Lv. 2400]" or v.Name == "Snow Demon [Lv. 2425]") and (v.HumanoidRootPart.Position - PosMonBone.Position).Magnitude <= 250 and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                v.HumanoidRootPart.Size = Vector3.new(50,50,50)
                                v.Humanoid:ChangeState(14)
                                v.HumanoidRootPart.CanCollide = false
                                v.Head.CanCollide = false
                        ...
                        if _G.AutoCandy1 and StartMagnetCandy1 then
                            if (v.HumanoidRootPart.Position - PosMonCandy1.Position).Magnitude <= 250 and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                                v.HumanoidRootPart.Size = Vector3.new(50,50,50)
                                v.Humanoid:ChangeState(14)
                                v.HumanoidRootPart.CanCollide = false
                                v.Head.CanCollide = false
                                v.HumanoidRootPart.CFrame = PosMonCandy1
                                if v.Humanoid:FindFirstChild("Animator") then
                                    v.Humanoid.Animator:Destroy()
                                end
                                sethiddenproperty(game:GetService("Players").LocalPlayer, "SimulationRadius", math.huge)
    ...
    FastAttack:AddSeperator("SuperFastAttack")

    FastAttack:AddToggle("SuperFastAttack",true,function(value)
...
elseif game.PlaceId == 4520749081 or game.PlaceId == 6381829480 or game.PlaceId == 5931540094 or game.PlaceId == 5931540094 then
    ...
    --
    local RenUi = library:AddWindow("SunHub",Enum.KeyCode.RightControl)
    --
    local Main = RenUi:AddTab("Auto Farm","6026568198")
    local Stats = RenUi:AddTab("Stats","7040410130")
    local Combat = RenUi:AddTab("Combat","7251993295")
